...
Route::get('/buscar_estudiante', [TbestudianteController::class, 'buscarPorCedulaONombre']);
...
Route::put('/actualizar_estudiante/{id}', [TbestudianteController::class, 'update']);
...
Route::get('/consultar_datosBasicos_tutor', [TbtutorController::class, 'consultarDatosBasicos']);
Route::post('/crear_tutor', [TbtutorController::class, 'store']);
Route::put('/actualizar_tutor/{id}', [TbtutorController::class, 'update']);             
Route::delete('/eliminar_tutor/{id}', [TbtutorController::class, 'destroy']);
Route::get('/buscar_tutor', [TbtutorController::class, 'buscarPorCedulaONombre']);
...
Route::put('/actualizar_usuario/{id}', [TbusuariosController::class, 'update']);
Route::delete('/eliminar_usuario/{id}', [TbusuariosController::class, 'destroy']);

//Tipo proyecto
Route::get('/buscar_proyecto_titulo', [TbproyectoController::class, 'buscarPorTitulo']);
...
Route::put('/actualizar_proyecto/{id}', [TbproyectoController::class, 'update']);
...
Route::put('/actualizar_carrera/{id}', [TbcarreraController::class, 'update']);
...
Route::put('/actualizar_grupo/{id}', [TbgrupoController::class, 'update']);
...
Route::put('/actualizar_tipo_usuario/{id}', [TbtipousuarioController::class, 'update']);
...
Route::put('/actualizar_area_investigacion/{id}', [TbareainvestigacionController::class, 'update']);
